<template>
  <div class="container">
    ...
    <div class="accordion" id="accordionExample">
      <div class="accordion-item wow animate__animated animate__fadeInLeft" data-wow-duration="1s" data-wow-delay="0s"
      ...
      <div class="accordion-item wow animate__animated animate__fadeInRight" data-wow-duration="1s" data-wow-delay="0s"
        data-wow-iteration="1">
      ...
      <div class="accordion-item wow animate__animated animate__fadeInLeft" data-wow-duration="1s" data-wow-delay="0s"
        ...
        <div id="collapse03" class="accordion-collapse collapse" aria-labelledby="headingThree"
          data-bs-parent="#accordionExample">
          <div class="accordion-body">
      ...
      <div class="accordion-item wow animate__animated animate__fadeInRight" data-wow-duration="1s" data-wow-delay="0s"
        ...
        <div id="collapse04" class="accordion-collapse collapse" aria-labelledby="headingThree"
          data-bs-parent="#accordionExample">
          <div class="accordion-body">
      ...
      <div class="accordion-item wow animate__animated animate__fadeInLeft" data-wow-duration="1s" data-wow-delay="0s"
        ...
        <div id="collapse09" class="accordion-collapse collapse" aria-labelledby="headingThree"
          data-bs-parent="#accordionExample">
          <div class="accordion-body">
